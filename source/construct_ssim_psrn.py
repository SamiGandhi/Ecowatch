...
source_directory = 'C:\\Users\\Gandhi\\Desktop\\exper'

#the five setup names 
setups = ['Autumn','Spring','Summer','Winter','No_Noise']

setup_dict = {
    'mjpeg_light':'288X288\\MPEG\\light\\GOP_12',
    'mjpeg_medium':'288X288\\MPEG\\Medium\\GOP_12',
    'proposed_light':'288X288\\ROI\\light',
    'proposed_medium':'288X288\\ROI\\medium'
}
...
for key, video_out_base_path in videos_dict.items():
    ...
    for key, noise_directory_name in noise_dict.items():
        ...
        proposed_light_directory = os.path.join(directory,setup_dict['proposed_light'])
